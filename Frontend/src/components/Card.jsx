  ...
  },
  {
    ...
    content: () => {
      return (
        <p>
          {" "}
          a Bollywood movie starring Emraan Hashmi, is renowned for its intense
          storyline and powerful performances. Directed by Mohit Suri, the film
          has become a significant work in the Indian film industry. <br />{" "}
          <br />
          ...
          gripping narrative and memorable music, has garnered a massive fan
          following both in India and abroad, solidifying Emraan Hashmis status
