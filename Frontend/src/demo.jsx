	...
	<div className="rounded-lg w-full md:w-3/4 lg:w-2/3">
		...
		<div className="p-12 pt-16 bg-slate-200 mb-[30px]">
			<div className="flex justify-between">
				{/* User Info */}
				<div>
					<h1 className="text-3xl font-bold text-gray-800">Rahul Bhandari</h1>
			...
			<div className="mt-8">
				...
				<p className="text-gray-600 mt-2">
					...
					currently managing a team of 90 professionals to ensure quality across
					key products. I am also dedicated to social causes, reflecting my
